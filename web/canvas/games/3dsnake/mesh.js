...
function rotate(point, rotation) {
    const sin = new Vec(Math.sin(rotation.x), Math.sin(rotation.y), Math.sin(rotation.z));
    const cos = new Vec(Math.cos(rotation.x), Math.cos(rotation.y), Math.cos(rotation.z));
    ...
    temp1 = cos.z * point.y + sin.z * point.x;
    temp2 = -sin.z * point.y + cos.z * point.x;
    point.y = temp1;
    point.x = temp2;    
}
