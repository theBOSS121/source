...
public class Sprite {
	...
	public static Sprite player_side2 = new Sprite(32, 3, 5, SpriteSheet.tiles);
	
	public static Sprite player_forward_1 = new Sprite(32, 0, 6, SpriteSheet.tiles);
	public static Sprite player_back_1= new Sprite(32, 2, 6, SpriteSheet.tiles);
	public static Sprite player_side_1 = new Sprite(32, 1, 6, SpriteSheet.tiles);
	public static Sprite player_side2_1 = new Sprite(32, 3, 5, SpriteSheet.tiles);

	public static Sprite player_forward_2 = new Sprite(32, 0, 7, SpriteSheet.tiles);
	public static Sprite player_back_2 = new Sprite(32, 2, 7, SpriteSheet.tiles);
	public static Sprite player_side_2 = new Sprite(32, 1, 7, SpriteSheet.tiles);
	public static Sprite player_side2_2 = new Sprite(32, 3, 5, SpriteSheet.tiles);
	
	//bomb
	public static Sprite bomb = new Sprite(16, 3, 0, SpriteSheet.tiles);
	public static Sprite explodedBomb = new Sprite(16, 4, 0, SpriteSheet.tiles);
	
	//speed, plusBomb, plusRange
	public static Sprite speed = new Sprite(16, 5, 0, SpriteSheet.tiles);
	public static Sprite plusBomb = new Sprite(16, 6, 0, SpriteSheet.tiles);
	public static Sprite plusRange = new Sprite(16, 7, 0, SpriteSheet.tiles);
